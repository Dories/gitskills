//0720 生成excel表的插件 yhb
function createExc(key,success_callback,failed_callback){
     // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "putSaveData", [key]);
    }
    
    // Android
    else if(brows().android) {
        return cordova.exec(success_callback, failed_callback, "CreateExcel", "createExc", key);
    }
    
}
//0720 生成excel表的插件 yhb
function createPDF(key,success_callback,failed_callback){
     // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "putSaveData", [key]);
    }
    ...
    // Android
        ...
        return cordova.exec(success_callback, failed_callback, "CreateExcel", "createPDF", key);
    }
    
}
//0720 生成excel表的插件 yhb
function createNum(key,success_callback,failed_callback){
     // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "putSaveData", [key]);
    }
    ...
    // Android
        ...
        return cordova.exec(success_callback, failed_callback, "CreateExcel", "createNum", key);
    }
 ...
 *  返回值:  成功返回 "1" 失败返回 "0"(均调用成功回调)
 */
function putSaveData(key,success_callback, failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "putSaveData", [key]);
    }
    ...
    // Android
        ...
        return cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "putSaveData", key);
    }
}
/**  向本地存储数据
 *  key [{key:value},{key:value}] 
 *  返回值:  成功返回 "1" 失败返回 "0"(均调用成功回调)
 */
function putSaveData1(key,success_callback, failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "putSaveData", [key]);
    }
    ...
    // Android
        ...
        return cordova.exec(success_callback, failed_callback, "TableDataPlugin", "putSaveData", key);
    }
}


//问题件生成加密签名包
function getEncFile_problem (success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"ElectronicSignaturePlugin","getEncFile",[]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"ElectronicSignatureGetFilePlugin","doSignatureProblem","");
    }
}
//电子回执生成加密签名包
function getEncFile_receipt (success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"ElectronicSignaturePlugin","getEncFile",[]);
    }
    // Android
        ...
        return  cordova.exec(success_callback,failed_callback,"ElectronicSignatureGetFilePlugin","doSignatureReceipt","");
    }
}
 ...
 *  返回值:  成功返回 "1" 失败返回 "0"(均调用成功回调)
 */
function putCoverSaveData(key,success_callback, failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "putSaveData", [key]);
    }
 ...
 *  返回值:  成功返回 "1" 失败返回 "0"(均调用成功回调)
 */
function putCoverSaveData1(key,success_callback, failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "putSaveData", [key]);
    }
...
/**  读取本地存储数据
 *  key 读取字段名
 *  返回值:  成功返回 "123135412" 失败返回 "0"(均调用成功回调)
 */
function getSaveData(key,success_callback, failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "getSaveData", [key]);
    }
    
    // Android
    else if(brows().android) {
        return cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "getSaveData", key);
    }
}
 ...
 *  返回值:  成功返回 "123135412" 失败返回 "0"(均调用成功回调)
 */
function getSaveData1(key,success_callback, failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "FileOperationPlugin", "getSaveData", [key]);
    }
    ...
    // Android
        ...
        return cordova.exec(success_callback, failed_callback, "TableDataPlugin", "getSaveData", key);
    }
}
 ...
 *  @return 用户JSON
 */
function getUserInfo (success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"UserPlugin","getUserInfo",[]);
    }
    // Android
    else if(brows().android) {
		//alert("111111");
        return  cordova.exec(success_callback,failed_callback,"UserPlugin","getUserInfo","");
    }
}
 ...
 *  @return
 */
function doSignature (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"ElectronicSignaturePlugin","doSignature",[key]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"ElectronicSignaturePlugin","doSignature",key);
    }
}
function doSignatureCopy (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"ElectronicSignaturePlugin","doSignatureCopy",[key]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"ElectronicSignatureCopyPlugin","doSignatureCopy",key);
    }
}
function getEncFile (success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"ElectronicSignaturePlugin","getEncFile",[]);
    }
    // Android
        ...
        return  cordova.exec(success_callback,failed_callback,"ElectronicSignatureGetFilePlugin","doSignatureCopy","");
    }
}

//天津人身保险产品销售服务确认书生成加密签名包
function getEncFile_confirmation (success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"ElectronicSignaturePlugin","getEncFile",[]);
    }
    // Android
        ...
        return cordova.exec(success_callback,failed_callback,"ElectronicSignatureGetFilePlugin","doSignatureConfirmation","");
    }
}
/** ==================== 获取最后登陆用户 ==================== */
/**
...
function openPDFAsset(key, success_callback, failed_callback) {
    //ios
    if(brows().iphone) {
    ...
    // Android
       ...
       // alert("android");
        return cordova.exec(success_callback, failed_callback, "TransformPDFPlugin", "openPDFAsset", key);
    }
}
 ...
 *  @return 字典的集合
 */
function queryDataSizeSql (key,success_callback,failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback,failed_callback,"TableDataPlugin","queryDataSizeSql",[key]);
    }
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback,failed_callback,"TableDataPlugin","queryDataSizeSql",key);
    }
}
 ...
 *  @brief
 *
 *  @key    {"readPath": "1.pdf,2.pdf"} 传入需要读取的PDF文件用","分割
 *  @param  success_callback    成功回调
 *  @param  failed_callback"    失败回调
 *
 *  @return 成功返回1  失败返回0
...
function loadPDFPath(key, success_callback, failed_callback) {
    //ios
    if(brows().iphone) {
        
        cordova.exec(success_callback, failed_callback, "TransformPDFPlugin", "loadPDFPath", [key]);
    }
    // Android
    else if(brows().android) {
        
        return cordova.exec(success_callback, failed_callback, "TransformPDFPlugin", "loadPDFPath", key);
    }
}
 ...
 *  @brief   下载Cover图片(建议书)
 *
 *  @param  key    最后更新时间,"22222222222"
 *  @param  success_callback    成功回调
 *  @param  failed_callback"    失败回调
 *
 *  @return 增加数据库成功返回1  增加数据库失败返回0
 */
function downloadCover(key,success_callback,failed_callback){
    // iOS
    if(brows().iphone) {
        
        cordova.exec(success_callback,failed_callback,"DownloadPlugin","downloadCover",[key]);
    }
    // Android
    else if(brows().android) {
        
        return  cordova.exec(success_callback,failed_callback,"DownloadPlugin","downloadCover",key);
    }
}
/** ==================== 下载PRODUCT ==================== */
 ...
 *  @return 增加数据库成功返回1  增加数据库失败返回0
 */
function downloadProduct(key,success_callback,failed_callback){
    // iOS
    if(brows().iphone) {
        
        cordova.exec(success_callback,failed_callback,"DownloadPlugin","downloadProduct",[key]);
    }
    // Android
    else if(brows().android) {
        
        return  cordova.exec(success_callback,failed_callback,"DownloadPlugin","downloadProduct",key);
    }
}
 ...
 *  返回值:    图片的地址URL    (string)
 */
function getPhotoFromCamera1(key,success_callback, failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "PhotoPlugin1", "photoCamera", [key]);
    }
    
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback, failed_callback, "PhotoPlugin1", "photoCamera", [key]);
    }
}
 ...
 *   根据下标返回json
 */
function getJsonPoiPlugin(key,success_callback, failed_callback) {
    // iOS
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "GetJsonPoiPlugin", "", [key]);
    }
    
    // Android
    else if(brows().android) {
        return  cordova.exec(success_callback, failed_callback, "GetJsonPoiPlugin", "", key);
    }
}
...
function deleteFilePath(key, success_callback, failed_callback) {
    //ios
    if(brows().iphone) {
        cordova.exec(success_callback, failed_callback, "deleteDirPath", "deleteFilePath", [key]);
    }
    // Android
    else if(brows().android) {
        
        return cordova.exec(success_callback, failed_callback, "CleanDirPlugin", "deleteFilePath", key);
    }
}